package com.rigsec.utils.common;

import android.os.Environment;
import android.support.annotation.IntDef;
import android.util.Log;

import com.rigsec.bases.app.LibApplication;
    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = LibApplication.getAppInstance().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = LibApplication.getAppInstance().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
