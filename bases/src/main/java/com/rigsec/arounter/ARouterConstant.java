...
public class ARouterConstant {
    ...
    //跳转到登陆页面
    public static final String ACTIVITY_LOGIN_ACTIVITY = "/login/MeLoginActivity";
    //跳转到注册页面
    public static final String ACTIVITY_REGISTER_ACTIVITY = "/login/MeRegisterActivity";
    //跳转到玩Android模块的首页面
    ...
    //记事本首页
    public static final String ACTIVITY_NOTE_ACTIVITY = "/note/NotePadActivity";
    //markdown首页
    ...
    //绘画页面
    public static final String ACTIVITY_BOOK_DOODLE_ACTIVITY = "/book/DoodleViewActivity";
    //画廊页面
    public static final String ACTIVITY_OTHER_GALLERY_ACTIVITY = "/other/ImageGalleryActivity";
    //老虎机页面
    public static final String ACTIVITY_OTHER_MONKEY_ACTIVITY = "/other/MonkeyGameActivity";
    //微信新闻首页
    public static final String ACTIVITY_NEW_WX_ACTIVITY = "/news/TxWeChatNewsActivity";
    //todo页面
    public static final String ACTIVITY_WORK_ACTIVITY = "/todo/WorkDoActivity";
    //跳转到豆瓣电影页面
    ...
    //今日头条
    public static final String ACTIVITY_WY_NEWS_ACTIVITY = "/news/WyNewsActivity";
    //天行新闻
    public static final String ACTIVITY_TX_NEWS_ACTIVITY = "/news/TxNewsActivity";
    //表达爱意
    public static final String ACTIVITY_LOVE_ACTIVITY = "/love/LoveGirlMainActivity";
    //跳转到知乎webView详情页面
    public static final String ACTIVITY_ZHI_HU_WEB_VIEW = "/zhihu/WebViewAnimActivity";
    //关于仿杀毒软件进度条控件
